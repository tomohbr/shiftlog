...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      {
        q: 'スタッフはどうやってログインする？',
        a: '①「オーナー・店長ログイン」ではなく「スタッフログイン」を選択 → ②会社PIN（6桁）を入力 → ③一覧から自分の名前をタップ。通常はこれだけでログインできます。会社PINはオーナーが「会社管理」画面で確認できます。',
      },
      {
        q: 'データは安全？',
  ...
  },
  {
    ...
    items: [
      {
        q: 'スタッフを追加するには？',
        a: '「スタッフ管理」→「+スタッフ追加」。氏名だけでも追加できます。時給・役割（スタッフ/店長）などは必要に応じて入力してください。打刻用PINはProプランの任意セキュリティ機能です。',
      },
      {
        q: 'スタッフの時給を変更したい',
